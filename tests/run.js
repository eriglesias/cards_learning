...
import * as TrainerTests from './trainer.test.js'
import * as prepositionDomainTests from './prepositions-domain.test.js'
...
let failures =0;
const suites = [evaluatorTests, factoryTests, TrainerTests, prepositionDomainTests];
